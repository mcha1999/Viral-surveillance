  ...
  theme: {
    extend: {
      colors: {
        ...
        // Risk level colors (with both CSS var and direct values for flexibility)
        risk: {
          low: 'var(--risk-low)',
          ...
          // Direct values for components that can't use CSS vars
          critical: '#7c2d12',
        },
        ...
        // Wastewater "sludge" colors (existing)
        sludge: {
          receding: '#1e40af',
          stable: '#6b7280',
          surging: '#dc2626',
